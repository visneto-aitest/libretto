...
<Card title="Setting up? See the Configuration reference" icon="gear" href="./configuration">
  Details on supported AI providers, environment variables, config file options, and how to change your setup after the initial install.
</Card>
