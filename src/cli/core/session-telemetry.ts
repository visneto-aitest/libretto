...
type InstallSessionOwnerTelemetryOptions = {
...
// Installs the long-lived telemetry owned by the process that launched the browser session.
export async function installSessionOwnerTelemetry(
  options: InstallSessionOwnerTelemetryOptions,
): Promise<void> {
